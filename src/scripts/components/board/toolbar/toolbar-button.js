...
export default class ToolbarButton {
  ...
  constructor(params, callbacks) {
    ...
    this.dom.classList.add('toolbar-button-wrapper');
    ...
    if (this.params.keyshortcuts) {
      this.button.setAttribute('aria-keyshortcuts', this.params.keyshortcuts);
    }
   ...
   */
  cloak() {
    this.dom.classList.add('cloaked');
  }
   ...
   */
  decloak() {
    this.dom.classList.remove('cloaked');
  }
